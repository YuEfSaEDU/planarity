...
express_sourcefiles = [
    "planarity/express/planarity.pyx"
]
express_sourcefiles.extend(glob("planarity/c/graphLib/**/*.c", recursive=True))
...
extensions = [
    Extension(
        name="planarity.express.planarity",
        sources=express_sourcefiles,
